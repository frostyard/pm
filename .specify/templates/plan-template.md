...
**Primary Dependencies**: [e.g., stdlib + golangci-lint + any SDKs or NEEDS CLARIFICATION]
**Storage**: [if applicable, e.g., PostgreSQL, CoreData, files or N/A]
**Testing**: `go test ./...` (unit tests required for every change)
...
```text
# [REMOVE IF UNUSED] Option 1: Go library (DEFAULT for this repo)
cmd/
internal/
pkg/
